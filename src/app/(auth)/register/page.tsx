...
function RegisterPage() {
    ...
    const handleSubmit = async(e:React.FormEvent<HTMLFormElement>)=>{
        ...
        // ! NOTE:- if i  dont  use String here  TS will give me error on register method
        // ! Argument of type 'FormDataEntryValue | null' is not assignable to parameter of type 'string'.
        // ! Argument of Type 'null' is not assignable to type 'string'.ts(2345)
        ...
        // * ERROR WE ARE GETTING FROM APPWRITE
        if(response.error){
            // * ? => we optinal chain but ! => means forcefully get the message  
